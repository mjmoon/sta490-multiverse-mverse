...
In this demonstration, we omitted considerations for any covariates. In the following section, we demonstrate a multiverse analysis with an example for incorporating a covariate.
